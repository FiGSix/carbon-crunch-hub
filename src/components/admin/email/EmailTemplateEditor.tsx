...
import { Save, FileText, Info, Eye } from "lucide-react";
...
const PREVIEW_DATA = {
  ...
  proposalTitle: "Solar Installation Proposal",
  proposalUrl: "#preview-link",
  onboardingUrl: "#onboarding-link",
  agentName: "Sarah Johnson",
  agentEmail: "sarah@crunchcarbon.com",
  systemSize: "150 kWp",
  carbonCredits: "850",
  creditValue: "R42,500"
};
      ...
      <CardContent>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <ScrollArea className="h-[600px] w-full rounded-lg border bg-muted/30 p-4">
              <iframe
                srcDoc={previewHtml}
                className="w-full min-h-[580px] bg-background rounded shadow-sm"
                title="Email Preview"
