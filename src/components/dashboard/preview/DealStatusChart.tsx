...
const data = [
  { name: 'Draft', value: 4, color: '#8C8789' },    // Light gray
  { name: 'Pending', value: 6, color: '#FFE580' },  // Lighter yellow
  { name: 'Signed', value: 8, color: '#FFCD03' },   // Primary yellow (brand yellow)
  { name: 'Declined', value: 2, color: '#231F20' }, // Dark gray (brand black)
];
