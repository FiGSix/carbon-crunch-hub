    ...
    <footer className={cn("bg-white border-t border-crunch-black/5 py-12", className)}>
      <div className="grid-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-bold text-lg mb-4 uppercase text-crunch-black">SERVICES</h3>
          ...
          <div>
            <h3 className="font-bold text-lg mb-4 uppercase text-crunch-black">RESOURCES</h3>
            <ul className="space-y-2">
          ...
          <div>
            <h3 className="font-bold text-lg mb-4 uppercase text-crunch-black">LEGAL</h3>
            <ul className="space-y-2">
