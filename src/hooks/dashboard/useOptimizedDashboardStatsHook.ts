...
/**
 * Phase 5 Optimization: Replace existing dashboard stats hook with optimized version
 */
export function useOptimizedDashboardStatsHook(): DashboardStats & { isLoading: boolean; error: string | null } {
  ...
  return {
    ...
    pendingProposals: data?.activeProposals || 0,
    approvedProposals: data?.signedProposals || 0,
    totalRevenue: data?.totalRevenue || 0,
    totalEnergyOffset: data?.totalCarbonCredits || 0,
    isLoading,
