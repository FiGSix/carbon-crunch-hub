...
// Re-export from the new modular services
export { synchronizeUserRole } from './profile/roleSyncService'
export { getProfile, updateProfile } from './profile/profileOperations'
...
export async function getProfileById(profileId: string) {
  ...
  try {
    ...
    const { getProfile } = await import('./profile/profileOperations')
