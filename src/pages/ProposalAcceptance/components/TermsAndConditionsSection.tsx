          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="ml-4 space-y-2 text-sm">
                ...
                <p><strong>7.1.1</strong> 1. Open an account in the relevant Registry.</p>
                <p><strong>7.1.2</strong> 2. Be responsible for all administrative and financial implications of maintaining such account.</p>
                <p><strong>7.1.3</strong> 3. CDSA shall bear the costs associated with the VVB, registry fees and any and all audit fees.</p>
            ...
            <section>
              ...
              <div className="ml-4 space-y-2 text-sm">
                ...
                <p><strong>12.2</strong> An impediment under clause 12.1.1 may result from events such as the following, this enumeration not being exhaustive:</p>
