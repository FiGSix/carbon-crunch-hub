...
/**
 * Simplified Testimonials Section without animations for debugging
 */
export const SimplifiedTestimonialsSection = () => {
  console.log("[SimplifiedTestimonialsSection] Rendering simplified testimonials");
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-crunch-black/70 max-w-3xl mx-auto">
            Join thousands of system owners already monetising their clean energy.
          </p>
        </div>
...
const TestimonialCard = ({ testimonial }: TestimonialCardProps) => {
  return (
    <div className="bg-white p-8 rounded-lg shadow-md border border-crunch-black/10 h-full transition-all hover:shadow-lg">
