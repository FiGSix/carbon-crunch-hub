...
export const SocialProofSection = () => {
  return <section className="border-y border-crunch-black/10 bg-crunch-black/5 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-6 md:gap-0 justify-between items-center">
          <p className="text-crunch-black/80 font-medium">Trusted by solar funders, business owners and farmers across South Africa</p>
          <div className="flex gap-8 items-center">
            <div className="text-center">
              <motion.div className="text-2xl font-bold text-crunch-black" whileHover={{
              scale: 1.1
            }}>1,500+</motion.div>
