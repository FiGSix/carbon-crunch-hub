...
export function validateStep2(data: Step2Data): string | null {
  ...
  if (!data.signed_pdf_url || data.signed_pdf_url.trim() === '') {
    return "The PDF upload did not complete successfully. Please try uploading again or check your internet connection.";
  }
