...
export async function addCessionAgreementPages(
  ...
  addClause('9.5.1.5', 'If it is established that such use infringes any third party\'s intellectual property right, the infringing party –', 20);
  
  // Two bullet points as per source document
  drawText('• shall at its own expense and risk take such measures as to ensure that the infringement is obviated and that the non-infringing party\'s use of the information is not affected;', 10, fonts.regular, textColor, 60);
  drawText('• hereby indemnifies the non-infringing party against any claims brought by such third parties, provided that the non-infringing party notifies the infringing party in writing of such claims forthwith and permits the infringing party to defend any such claim.', 10, fonts.regular, textColor, 60);
  y -= 20;

  // === 10. REVENUE ===
  addHeading('10. REVENUE, MONETARY ARRANGEMENTS, AND RELATED RESPONSIBILITIES', 'section');
  drawText('CDSA shall assume the following obligations for the commercialization of carbon credits for the purpose of achieving profitability:', 10, fonts.regular);
  y -= 10;
  addClause('10.1.1', '1. Open an account in the relevant Registry.');
  addClause('10.1.2', '2. Be responsible for all administrative and financial implications of maintaining such account.');
  addClause('10.1.3', '3. CDSA shall bear the costs associated with the VVB, registry fees and any and all audit fees.');
  addClause('10.1.4', 'CDSA shall be responsible for the sale of the Carbon Credits generated by the Project, including all administrative and financial considerations, as well as the implementation of marketing activities and the identification of potential buyers or as otherwise agreed between the parties. This shall be deduced in an appendix. CDSA shall ensure transparency in the sales process by providing periodic updates to the Owner, including relevant market insights and pricing trends. The Owner may, upon request, provide input on potential buyers or negotiations; however, CDSA shall retain final decision-making authority to ensure efficient execution of sales at market-related rates.');
  addClause('10.1.5', 'Additionally, CDSA shall exercise its discretion in determining the entities to which the Carbon Credits will be sold. This discretion encompasses the selection of interested parties and the negotiation of terms for the sale of the Carbon Credits.');
  addClause('10.1.6', 'Revenue paid out to the owner is stipulated as per the signed proposal.');
  addClause('10.1.7', 'Or to retain and hold the Carbon Credits in its own name. If the Owner elects to hold the Carbon Credits, all costs and fees related to issuance, transfer, registration, or ongoing management shall be for the Owner\'s account, and CDSA or Crunch Carbon shall bear no responsibility or liability for such costs or activities.');
  addClause('10.1.8', 'It is specifically recorded and agreed that the transfer of the revenue to the Aggregator and subsequently to the owner shall be conducted periodically on an annual basis throughout the subsistence of this Cession Agreement.');
  addClause('10.1.9', 'Feedback will be provided at least quarterly or as required by the project owners.');
  y -= 20;

  // === 11. INCORPORATION ===
  addHeading('11. INCORPORATION OF THIS AGREEMENT INTO THE PROVISIONS OF THE AGREEMENT', 'section');
  addClause('11.1', 'It is specifically agreed that this Agreement, shall form an integral and indivisible part of this Cession Agreement, to the extent that the content of this Agreement, including subsequent amendments made to this Agreement, shall be regarded by the parties as fully incorporated into the provisions of this Cession Agreement.');
  y -= 20;
  ...
  addClause('12.2', 'The Owner may request the removal of a specific Unit by giving 30 days written notice. Such removal applies only to future periods and shall not reverse cessions already utilised for audits, submissions or issued vintages.');
  addClause('12.3', 'Other than Clause 9.1 either party will be entitled to terminate the agreement by providing 30-days written notice to the other in the event of:');
  addClause('12.3.1', 'the other party committing a breach of the terms and conditions of this Cession Agreement, all of which are declared to be material and failing to remedy the breach within 14 (Fourteen) days of written notice calling upon the other party to remedy the breach complained of;', 20);
  addClause('12.3.2', 'In the event of either of the Parties ("the defaulting party") committing a breach of any of the terms of this Cession Agreement and failing to remedy such breach within a period of 14 (Fourteen) days after receipt of a written notice from the other party ("the aggrieved party") calling upon the defaulting party so to remedy, then the aggrieved party shall be entitled, either claims specific performance of the terms of this Cession Agreement or to cancel this Cession Agreement forthwith and without further notice.', 40);
  addClause('12.3.3', 'the other party committing an act of insolvency or being sequestrated/liquidated or being placed under a provisional or final winding-up or judicial management order or if the other party makes an assignment for the benefit of creditors.', 40);
  addClause('12.4', 'The termination of this Cession Agreement, for whatever reason, will not affect the rights of a party which may have accrued as at the date of termination and will further not affect any rights and obligations which specifically or by their nature survive the termination of this Cession Agreement.');
  y -= 20;

  // === 13. DISPUTE RESOLUTION ===
  addHeading('13. DISPUTE RESOLUTION', 'section');
  addClause('13.1', 'In the event of a dispute arising from, or incidental to, this Cession Agreement, the Parties agree to submit the matter for mediation and failing which to arbitration.');
  addClause('13.2', 'Notwithstanding the above provisions, the Parties will be entitled to approach a Court of competent jurisdiction for urgent relief.');
  y -= 20;

  // === 14. ARBITRATION ===
  addHeading('14. ARBITRATION', 'section');
  addClause('14.1', 'Save where otherwise provided for in this Cession Agreement, any dispute between the Parties hereto (and which dispute has previously been submitted to mediation without resolution) in regard to:');
  addClause('14.1.1', 'the interpretation of; or', 20);
  addClause('14.1.2', 'the effect of; or', 20);
  addClause('14.1.3', 'the carrying out of; or', 20);
  addClause('14.1.4', 'any other matter arising directly or indirectly out of, this Cession Agreement, shall be submitted to and decided by arbitration.', 20);
  addClause('14.2', 'The arbitration shall be held informally but otherwise under the provisions of the Arbitration Act No.42 of 1965, as amended from time to time, or any Act passed in substitution for it; it being the intention as far as possible that the arbitration shall be held and concluded within 21 (twenty one) days after it has been demanded by way of written notice of either party to the other party. The Parties shall be entitled to be represented at the arbitration.');
  addClause('14.3', 'The arbitrator shall be, if the matter in issue is:');
  addClause('14.3.1', 'primarily an accounting matter an independent chartered accountant of not less than 15 (Fifteen) years\' standing, practising as a registered auditor, agreed upon between the Parties;', 20);
  addClause('14.3.2', 'primarily a legal matter a practising attorney of not less than 15 (Fifteen) years\' standing, agreed upon between the Parties;', 20);
  addClause('14.3.3', 'any other matter an independent person agreed upon between the Parties.', 20);
  addClause('14.4', 'If the Parties cannot agree whether any matter in dispute falls under the clauses mentioned hereinabove within 7 (seven) days after arbitration has been demanded, then that dispute shall be submitted for decision in terms of clause 15.3.3 above within 7 (seven) days after the Parties have so failed to agree, in order that the arbitration can be held and concluded as far as possible within a period of 21 (twenty one) days referred to above.');
  addClause('14.5', 'If the Parties fail to agree on the appointment of an arbitrator, such failure to agree shall be referred to the Attorneys\' Association of Gauteng in order for the Association to appoint an arbitrator.');
  addClause('14.6', 'The decision of the arbitrator shall be final and binding upon the Parties and shall be carried into effect by them and made an order of any competent Court, including any decision regarding the costs of the arbitration which the arbitrator shall be empowered to make.');
  addClause('14.7', 'Notwithstanding the foregoing, any party shall be entitled to approach any court of competent jurisdiction for urgent relief.');
  y -= 20;

  // === 15. FORCE MAJEURE ===
  addHeading('15. FORCE MAJEURE', 'section');
  addClause('15.1', 'A party is not liable for a failure to perform any of its obligations in so far as it proves:');
  addClause('15.1.1', 'that the failure was due to an impediment beyond its control.', 20);
  addClause('15.1.2', 'that it could not reasonably be expected to have taken the impediment and its effects upon the party\'s ability to perform into account at the time of the conclusion of the contract; and', 20);
  addClause('15.1.3', 'that it could not reasonably have avoided or overcome the impediment or at least its effects.', 20);
  addClause('15.2', 'An impediment under clause 16.1.1 may result from events such as the following, this enumeration not being exhaustive:');
  addClause('15.2.1', 'war, whether declared or not, civil war, civil violence, riots and revolutions, acts of piracy, acts of sabotage.', 20);
  addClause('15.2.2', 'natural disasters such as violent storms, cyclones, earthquakes, tidal waves, floods, destruction by lightning, explosions, fires, destruction of machines, of factories and of any kind of installations.', 20);
  addClause('15.2.3', 'boycotts, strikes and lockouts of all kinds, go-slows, occupation of factories and premises, and work stoppages.', 20);
  addClause('15.2.5', 'acts of authority, whether lawful or unlawful, apart from acts for which the party seeking relief has assumed the risk by virtue of any other provisions of this Cession Agreement.', 20);
  addClause('15.3', 'Relief from liability for non-performance by reason of the provisions of this clause shall commence on the date upon which the party seeking relief gives notice of the impediment relied upon and shall terminate upon the date upon which such impediment ceases to exist, provided that if such impediment continues for a period of more than 30 (THIRTY) days, either party shall be entitled to terminate this Cession Agreement by written notice to the other party, without cause, penalty, claim or obligation in respect of any loss suffered or damages incurred as a result of such cancellation.');
  y -= 20;

  // === 16. DOMICILIUM ===
  addHeading('16. DOMICILIUM CITANDI ET EXECUTANDI AND NOTICES', 'section');
  addClause('16.1', 'The Parties choose as their domicilia citandi et executandi their respective addresses as set out hereinabove for all purposes arising out of or in connection with this Agreement at which physical or electronic mail addresses all processes and notices arising out of or in connection with this Agreement, its breach or termination may validly be served upon or delivered to the Parties.');
  addClause('16.2', 'Any notice, consent or other communication required or permitted hereunder from either party shall be in writing and shall –');
  addClause('16.2.1', 'If delivered by hand be deemed to have been duly received by the addressee on the date of delivery;', 20);
  addClause('16.2.2', 'If transmitted by facsimile or electronic mail be deemed to have been received by the addressee on the day following the date of transmission, unless the contrary is proved.', 20);
  addClause('16.3', 'Notwithstanding anything to the contrary contained or implied in this Agreement, a written notice or communication actually received by a party shall be an adequate written notice or communication to it notwithstanding that it was not sent to or delivered at its chosen domicilium citandi et executandi.');
  y -= 20;

  // === 17. TERMINATION ASSISTANCE ===
  addHeading('17. TERMINATION / EXPIRATION ASSISTANCE', 'section');
  addClause('17.1', 'On the expiration or termination of this Cession Agreement the Parties shall make themselves available for an exit meeting for the discussion and implementation of termination/expiration assistance.');
  y -= 20;

  // === 18. GENERAL ===
  addHeading('18. GENERAL', 'section');
  addClause('18.1', 'No variation, amendment, deletion or addition to this Agreement, including this clause, will be of any force or effect unless reduced to writing and signed by the parties.');
  addClause('18.2', 'No indulgence, extension of time, relaxation or latitude which any party (the "grantor") may show grant or allow to the other (the "grantee") shall constitute a waiver by the grantor of any of the grantor\'s rights and the grantor shall not thereby be prejudiced or estopped from exercising any of its rights against the grantee which may have arisen in the past or which might arise in the future.');
  addClause('18.3', 'Nothing contained in this Agreement shall constitute an agency, partnership, joint venture or similar relationship between any of the parties hereto or their affiliated companies.');
  addClause('18.4', 'All annexures and schedules attached to this Agreement are incorporated by reference and shall form an integral part of this Agreement.');
  y -= 30;
