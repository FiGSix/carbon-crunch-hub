...
export async function addCessionAgreementPages(
  ...
  y -= 10;
  addClause('7.1.1', '1. Open an account in the relevant Registry.');
  addClause('7.1.2', '2. Be responsible for all administrative and financial implications of maintaining such account.');
  addClause('7.1.3', '3. CDSA shall bear the costs associated with the VVB, registry fees and any and all audit fees.');
  ...
  addClause('12.2', 'An impediment under clause 12.1.1 may result from events such as the following, this enumeration not being exhaustive:');
