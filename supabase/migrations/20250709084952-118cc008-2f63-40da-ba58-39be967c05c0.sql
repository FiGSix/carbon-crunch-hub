-- Database Performance Optimization: Fix Over-indexing on Proposals Table
...
-- 2. Keep only the most optimized indexes that cover multiple query patterns
...
-- 3. Create final optimized index set comment for documentation
