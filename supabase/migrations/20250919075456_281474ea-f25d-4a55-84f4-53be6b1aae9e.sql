-- Complete fix for bulk agent deletion (with trigger cleanup)
-- Step 1: Make agent_id nullable in proposals table
ALTER TABLE public.proposals 
ALTER COLUMN agent_id DROP NOT NULL;

-- Step 2: Drop existing trigger if it exists
DROP TRIGGER IF EXISTS transfer_clients_before_agent_deletion ON public.profiles;

-- Step 3: Create function to transfer client ownership before agent deletion
...
-- Step 4: Create trigger to fire before profile deletion
