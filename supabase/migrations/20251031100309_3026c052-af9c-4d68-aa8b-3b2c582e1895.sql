-- Update get_agents_management_data to include portfolio_size_kwp for commission calculation
-- Drop and recreate the function to add new return column
