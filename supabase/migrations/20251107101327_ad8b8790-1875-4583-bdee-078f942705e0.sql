...
DROP FUNCTION IF EXISTS public.get_company_member_profiles(uuid, uuid);
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE company_members.company_id = _company_id 
      AND company_members.user_id = _requesting_user_id 
