-- Fix audit review requests logic in get_dashboard_metrics_by_stage
-- The function was incorrectly checking onboarding_complete instead of submitted_for_review
